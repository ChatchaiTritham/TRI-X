"""End-to-end empirical pipeline for TRI-X (seed = 42).

Regenerates every headline number reported in the TRI-X manuscript from REAL,
reproducible computation on a documented SYNTHETIC cohort:
