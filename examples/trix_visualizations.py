...
def create_srgl_flow_diagram(output_dir='outputs/figures'):
    ...
    gate1_box = FancyBboxPatch((2, 7.5), 6, 1.5,
                                boxstyle="round,pad=0.1",
                                edgecolor=COLORS['gate1'], facecolor='#FFE5E5', linewidth=3)
    ax.add_patch(gate1_box)
    ax.text(5, 8.7, 'Gate G1: Critical Red Flag Screening',
            ha='center', va='center', fontsize=12, fontweight='bold', color=COLORS['gate1'])
    ax.text(5, 8.2, 'Focal weakness • Thunderclap headache • Acute hearing loss\nDiplopia • Dysarthria • Severe ataxia',
            ha='center', va='center', fontsize=9)

    # Decision diamond for Gate 1
    decision1 = mpatches.FancyBboxPatch((4.2, 6.8), 1.6, 0.5,
                                         boxstyle="round,pad=0.05",
                                         edgecolor='black', facecolor='#FFF9E5', linewidth=2,
                                         transform=ax.transData)
    ax.add_patch(decision1)
    ax.text(5, 7.05, 'Red Flag\nDetected?', ha='center', va='center', fontsize=9, fontweight='bold')

    # YES path (Red Flag detected) → R1/R2
    arrow_yes1 = FancyArrowPatch((6, 7), (7.5, 7),
    ...
    # R1/R2 outcome box
    outcome_r1 = FancyBboxPatch((7.5, 6.5), 1.8, 1,
                                 boxstyle="round,pad=0.1",
                                 edgecolor=COLORS['danger'], facecolor='#FFE5E5', linewidth=2)
    ax.add_patch(outcome_r1)
    ax.text(8.4, 7.3, 'R1/R2', ha='center', va='center', fontsize=11, fontweight='bold', color=COLORS['danger'])
    ax.text(8.4, 6.85, 'Critical/High Risk\nImmediate Care', ha='center', va='center', fontsize=8)

    # NO path → Gate 2
    arrow_no1 = FancyArrowPatch((5, 6.8), (5, 6.0),
                                 arrowstyle='->', mutation_scale=15,
                                 linewidth=2, color='black')
    ...
    gate2_box = FancyBboxPatch((2, 4.5), 6, 1.3,
                                boxstyle="round,pad=0.1",
                                edgecolor=COLORS['gate2'], facecolor='#FFF4E5', linewidth=3)
    ax.add_patch(gate2_box)
    ax.text(5, 5.5, 'Gate G2: Risk Factor Assessment',
            ha='center', va='center', fontsize=12, fontweight='bold', color=COLORS['gate2'])
    ax.text(5, 5.0, 'Age >65 • Hypertension • Diabetes • CVD • Atrial fibrillation\nPrevious stroke/TIA • Vascular risk factors',
            ha='center', va='center', fontsize=9)

    # Decision diamond for Gate 2
    decision2 = mpatches.FancyBboxPatch((4.2, 3.8), 1.6, 0.5,
                                         boxstyle="round,pad=0.05",
                                         edgecolor='black', facecolor='#FFF9E5', linewidth=2,
                                         transform=ax.transData)
    ax.add_patch(decision2)
    ax.text(5, 4.05, 'High Risk\nFactors?', ha='center', va='center', fontsize=9, fontweight='bold')

    # YES path (High risk) → R2/R3
    arrow_yes2 = FancyArrowPatch((6, 4), (7.5, 4),
                                  arrowstyle='->', mutation_scale=15,
    ...
    # R2/R3 outcome box
    outcome_r2 = FancyBboxPatch((7.5, 3.5), 1.8, 1,
                                 boxstyle="round,pad=0.1",
                                 edgecolor=COLORS['warning'], facecolor='#FFF9E5', linewidth=2)
    ax.add_patch(outcome_r2)
    ax.text(8.4, 4.3, 'R2/R3', ha='center', va='center', fontsize=11, fontweight='bold', color=COLORS['warning'])
    ax.text(8.4, 3.85, 'High/Moderate Risk\nUrgent Evaluation', ha='center', va='center', fontsize=8)

    # NO path → Gate 3
    arrow_no2 = FancyArrowPatch((5, 3.8), (5, 3.0),
                                 arrowstyle='->', mutation_scale=15,
                                 linewidth=2, color='black')
    ...
    gate3_box = FancyBboxPatch((2, 1.5), 6, 1.3,
                                boxstyle="round,pad=0.1",
                                edgecolor=COLORS['gate3'], facecolor='#E5F2FF', linewidth=3)
    ax.add_patch(gate3_box)
    ax.text(5, 2.5, 'Gate G3: Uncertainty Quantification',
            ha='center', va='center', fontsize=12, fontweight='bold', color=COLORS['gate3'])
    ax.text(5, 2.0, 'Symptom clarity • Diagnosis confidence • Temporal pattern consistency\nVital sign stability • Comorbidity complexity',
            ha='center', va='center', fontsize=9)

    # Decision diamond for Gate 3
    decision3 = mpatches.FancyBboxPatch((4.2, 0.8), 1.6, 0.5,
                                         boxstyle="round,pad=0.05",
                                         edgecolor='black', facecolor='#FFF9E5', linewidth=2,
                                         transform=ax.transData)
    ...
    arrow_yes3 = FancyArrowPatch((6, 1), (7.5, 1),
                                  arrowstyle='->', mutation_scale=15,
    ...
    # R3 outcome box
    outcome_r3 = FancyBboxPatch((7.5, 0.5), 1.8, 1,
                                 boxstyle="round,pad=0.1",
                                 edgecolor=COLORS['info'], facecolor='#E5F2FF', linewidth=2)
    ax.add_patch(outcome_r3)
    ax.text(8.4, 1.3, 'R3', ha='center', va='center', fontsize=11, fontweight='bold', color=COLORS['info'])
    ax.text(8.4, 0.85, 'Moderate Risk\nObservation', ha='center', va='center', fontsize=8)

    # NO path → R4/R5
    arrow_no3 = FancyArrowPatch((4, 1), (2.5, 1),
                                 arrowstyle='->', mutation_scale=15,
    ...
    # R4/R5 outcome box
    outcome_r4 = FancyBboxPatch((0.7, 0.5), 1.8, 1,
                                 boxstyle="round,pad=0.1",
                                 edgecolor=COLORS['success'], facecolor='#E5F9F0', linewidth=2)
    ax.add_patch(outcome_r4)
    ax.text(1.6, 1.3, 'R4/R5', ha='center', va='center', fontsize=11, fontweight='bold', color=COLORS['success'])
    ax.text(1.6, 0.85, 'Low/Minimal Risk\nOutpatient Care', ha='center', va='center', fontsize=8)

    # Legend
    legend_elements = [
        mpatches.Patch(facecolor='#FFE5E5', edgecolor=COLORS['gate1'], label='Gate G1: Critical Screening', linewidth=2),
        mpatches.Patch(facecolor='#FFF4E5', edgecolor=COLORS['gate2'], label='Gate G2: Risk Assessment', linewidth=2),
        mpatches.Patch(facecolor='#E5F2FF', edgecolor=COLORS['gate3'], label='Gate G3: Uncertainty Check', linewidth=2),
    ]
    ax.legend(handles=legend_elements, loc='lower left', fontsize=9, frameon=True, shadow=True)

    # Save figure
    plt.savefig(f'{output_dir}/fig1_srgl_flow_diagram.png', dpi=600, bbox_inches='tight')
...
def create_framework_architecture(output_dir='outputs/figures'):
    ...
    # Title
    ax.text(7, 9.5, 'TRI-X Framework Architecture',
            ha='center', va='top', fontsize=18, fontweight='bold')

    # Three main components
    # Triage
    triage_box = FancyBboxPatch((0.5, 6.5), 3.5, 2.5,
                                 boxstyle="round,pad=0.15",
                                 edgecolor='#CC3311', facecolor='#FFE5E5', linewidth=3)
    ax.add_patch(triage_box)
    ax.text(2.25, 8.5, 'TRIAGE', ha='center', va='center', fontsize=14, fontweight='bold', color='#CC3311')
    ax.text(2.25, 7.8, 'Clinical Guidelines', ha='center', va='center', fontsize=10, fontweight='bold')
    ax.text(2.25, 7.3, '• ACEP Dizziness/Vertigo\n• AHA/ASA Stroke\n• AAO-HNS BPPV\n• Red Flag Detection',
            ha='center', va='center', fontsize=9)

    # TiTrATE
    titrate_box = FancyBboxPatch((5.25, 6.5), 3.5, 2.5,
                                  boxstyle="round,pad=0.15",
                                  edgecolor='#DE8F05', facecolor='#FFF4E5', linewidth=3)
    ax.add_patch(titrate_box)
    ax.text(7, 8.5, 'TiTrATE', ha='center', va='center', fontsize=14, fontweight='bold', color='#DE8F05')
    ax.text(7, 7.8, 'Diagnostic Framework', ha='center', va='center', fontsize=10, fontweight='bold')
    ax.text(7, 7.3, '• Symptom Patterns\n• Risk Factor Scoring\n• Temporal Analysis\n• Comorbidity Assessment',
            ha='center', va='center', fontsize=9)

    # XAI
    xai_box = FancyBboxPatch((10, 6.5), 3.5, 2.5,
                              boxstyle="round,pad=0.15",
                              edgecolor='#0173B2', facecolor='#E5F2FF', linewidth=3)
    ax.add_patch(xai_box)
    ax.text(11.75, 8.5, 'XAI', ha='center', va='center', fontsize=14, fontweight='bold', color='#0173B2')
    ax.text(11.75, 7.8, 'Explainability Layer', ha='center', va='center', fontsize=10, fontweight='bold')
    ax.text(11.75, 7.3, '• SHAP Values\n• LIME\n• NMF Phenotypes\n• Counterfactuals\n• Rule Extraction',
            ha='center', va='center', fontsize=9)

    # Arrows connecting components
    arrow1 = FancyArrowPatch((4, 7.75), (5.25, 7.75),
                              arrowstyle='->', mutation_scale=20,
                              linewidth=2.5, color='black')
    ax.add_patch(arrow1)

    arrow2 = FancyArrowPatch((8.75, 7.75), (10, 7.75),
                              arrowstyle='->', mutation_scale=20,
                              linewidth=2.5, color='black')
    ax.add_patch(arrow2)

    # SRGL Layer (underneath)
    srgl_box = FancyBboxPatch((1, 4.5), 12, 1.5,
                               boxstyle="round,pad=0.15",
                               edgecolor='#029E73', facecolor='#E5F9F0', linewidth=3)
    ax.add_patch(srgl_box)
    ax.text(7, 5.7, 'SRGL (Screening-First Risk Governance Logic)',
            ha='center', va='center', fontsize=13, fontweight='bold', color='#029E73')
    ax.text(7, 5.1, 'Gate G1: Critical Red Flags  →  Gate G2: Risk Factors  →  Gate G3: Uncertainty Quantification',
            ha='center', va='center', fontsize=10)

    # Arrows from components to SRGL
    for x_pos in [2.25, 7, 11.75]:
        arrow = FancyArrowPatch((x_pos, 6.5), (x_pos, 6.0),
                                 arrowstyle='->', mutation_scale=15,
                                 linewidth=2, color='black')
        ax.add_patch(arrow)

    # Output box
    output_box = FancyBboxPatch((3, 2.5), 8, 1.5,
                                 boxstyle="round,pad=0.15",
                                 edgecolor='black', facecolor='#F5F5F5', linewidth=3)
    ax.add_patch(output_box)
    ax.text(7, 3.7, 'DECISION OUTPUT', ha='center', va='center', fontsize=13, fontweight='bold')
    ax.text(7, 3.1, 'Risk Tier (R1-R5) + Urgency Level + Explanation + Care Pathway + Confidence Score',
            ha='center', va='center', fontsize=10)

    # Arrow from SRGL to Output
    arrow_out = FancyArrowPatch((7, 4.5), (7, 4.0),
                                 arrowstyle='->', mutation_scale=20,
                                 linewidth=2.5, color='black')
    ax.add_patch(arrow_out)

    # Input (top)
    input_box = FancyBboxPatch((4.5, 9.8), 5, 0.8,
                                boxstyle="round,pad=0.1",
                                edgecolor='black', facecolor='#E8E8E8', linewidth=2)
    ax.add_patch(input_box)
    ax.text(7, 10.2, 'PATIENT INPUT: Demographics, Symptoms, Vitals, Medical History',
            ha='center', va='center', fontsize=11, fontweight='bold')

    # Arrows from input to components
    for x_pos in [2.25, 7, 11.75]:
        arrow = FancyArrowPatch((7, 9.8), (x_pos, 9.0),
                                 arrowstyle='->', mutation_scale=15,
                                 linewidth=2, color='black')
        ax.add_patch(arrow)

    # DRAS-5 side note
    dras_box = FancyBboxPatch((0.3, 1.5), 2.5, 0.8,
                               boxstyle="round,pad=0.1",
                               edgecolor='#56B4E9', facecolor='#E5F9FF', linewidth=2)
    ax.add_patch(dras_box)
    ax.text(1.55, 1.9, 'DRAS-5 States', ha='center', va='center', fontsize=9, fontweight='bold', color='#56B4E9')
    ax.text(1.55, 1.6, '5 Decision-Risk-Action States', ha='center', va='center', fontsize=8)

    # ORASR side note
    orasr_box = FancyBboxPatch((11.2, 1.5), 2.5, 0.8,
                                boxstyle="round,pad=0.1",
                                edgecolor='#D55E00', facecolor='#FFE5D9', linewidth=2)
    ax.add_patch(orasr_box)
    ax.text(12.45, 1.9, 'ORASR Routing', ha='center', va='center', fontsize=9, fontweight='bold', color='#D55E00')
    ax.text(12.45, 1.6, 'Safety Routing & Care Pathways', ha='center', va='center', fontsize=8)

    # Bottom note
    ax.text(7, 0.8, 'Transparent • Auditable • Safety-First • Clinically-Grounded',
            ha='center', va='center', fontsize=11, fontweight='bold', style='italic', color='#555555')

    # Save figure
    plt.savefig(f'{output_dir}/fig2_framework_architecture.png', dpi=600, bbox_inches='tight')
...
def create_performance_dashboard_2d(output_dir='outputs/figures'):
    ...
    # Main title
    fig.suptitle('TRI-X Performance Dashboard (SynDX Validation)', fontsize=18, fontweight='bold', y=0.98)
    ...
    bars1 = ax1.bar(x - width/2, list(metrics.values()), width,
                     label='Achieved', color=COLORS['primary'], alpha=0.8, edgecolor='black', linewidth=1.5)
    bars2 = ax1.bar(x + width/2, list(targets.values()), width,
                     label='Target', color=COLORS['secondary'], alpha=0.6, edgecolor='black', linewidth=1.5)
    ...
    ax1.set_title('A. Achieved vs Target Performance', fontsize=13, fontweight='bold', pad=10)
    ax1.set_xticks(x)
    ...
    ax2.plot(angles, achieved_values, 'o-', linewidth=2, label='Achieved', color=COLORS['primary'])
    ax2.fill(angles, achieved_values, alpha=0.25, color=COLORS['primary'])
    ax2.plot(angles, target_values, 's--', linewidth=2, label='Target', color=COLORS['secondary'])
    ...
    bars = ax3.barh(range(len(metrics)), [1]*len(metrics), color=status_colors, alpha=0.7, edgecolor='black', linewidth=1.5)
    ...
    for i, (bar, label) in enumerate(zip(bars, status_labels)):
        ax3.text(0.5, i, label, ha='center', va='center', fontsize=11, fontweight='bold', color='white')
    ...
    passed_metrics = sum(1 for i, key in enumerate(metrics.keys())
                          if (metrics[key] >= targets[key] if 'Violations' not in key else metrics[key] <= targets[key]))
    ...
    # Summary box
    summary_box = FancyBboxPatch((0.1, 0.3), 0.8, 0.6,
                                  boxstyle="round,pad=0.05",
                                  edgecolor='black', facecolor='#F0F0F0', linewidth=2)
    ax4.add_patch(summary_box)

    ax4.text(0.5, 0.85, 'D. Summary Statistics', ha='center', va='center',
    ...
    status_box = FancyBboxPatch((0.25, 0.05), 0.5, 0.15,
                                 boxstyle="round,pad=0.02",
                                 edgecolor=status_color, facecolor=status_color, linewidth=3, alpha=0.3)
    ax4.add_patch(status_box)
    ax4.text(0.5, 0.125, status_text, ha='center', va='center',
             fontsize=12, fontweight='bold', color=status_color, transform=ax4.transAxes)

    # Save figure
    plt.savefig(f'{output_dir}/fig3_performance_dashboard_2d.png', dpi=600, bbox_inches='tight')
...
def create_performance_3d(output_dir='outputs/figures'):
    ...
    for i in range(len(age_groups)):
        for j in range(len(risk_levels)):
            ax.bar3d(i-0.2, j-0.2, 0, 0.4, 0.4, performance_data[i,j],
                     color=plt.cm.viridis(performance_data[i,j]/100), alpha=0.8, edgecolor='black')
    ...
    # Title
    ax.set_title('3D Performance Analysis: Age × Risk × Accuracy', fontsize=14, fontweight='bold', pad=20)
...
def create_risk_tier_distribution(output_dir='outputs/figures'):
    ...
    colors_list = [RISK_COLORS['R1'], RISK_COLORS['R2'], RISK_COLORS['R3'], RISK_COLORS['R4'], RISK_COLORS['R5']]

    # Panel A: Pie chart
    ax1 = axes[0]
    wedges, texts, autotexts = ax1.pie(frequencies, labels=risk_tiers, autopct='%1.1f%%',
    ...
    ax1.set_title('A. Risk Tier Distribution (Pie Chart)', fontsize=13, fontweight='bold', pad=15)

    # Panel B: Bar chart with counts
    ax2 = axes[1]
    bars = ax2.bar(risk_tiers, frequencies, color=colors_list, alpha=0.8, edgecolor='black', linewidth=2)
    ...
    ax2.set_title('B. Risk Tier Counts (n=500 Test Cases)', fontsize=13, fontweight='bold', pad=15)
    ax2.grid(axis='y', alpha=0.3, linestyle='--')
    ax2.set_ylim(0, max(frequencies)*1.2)

    # Add annotations
    ax2.text(0.5, 0.95, f'Total: {sum(frequencies)} cases',
    ...
    # Save figure
    plt.savefig(f'{output_dir}/fig5_risk_tier_distribution.png', dpi=600, bbox_inches='tight')
...
def create_xai_methods_comparison(output_dir='outputs/figures'):
    ...
    fig.suptitle('XAI Methods in TRI-X Framework', fontsize=16, fontweight='bold', y=0.995)

    # Panel A: SHAP Feature Importance (top features)
    ax1 = axes[0, 0]
    features = ['Nystagmus\nPattern', 'Age >65', 'Focal\nWeakness', 'Vascular\nRisk', 'Onset\nSudden',
                'Duration', 'Headache', 'Diabetes', 'Ataxia', 'Diplopia']
    shap_values = [0.842, 0.234, 0.198, 0.156, 0.123, 0.098, 0.087, 0.076, 0.065, 0.054]

    bars = ax1.barh(features, shap_values, color=COLORS['primary'], alpha=0.7, edgecolor='black', linewidth=1)
    ax1.set_xlabel('SHAP Importance', fontsize=11, fontweight='bold')
    ax1.set_title('A. SHAP Feature Importance (Top 10)', fontsize=12, fontweight='bold', pad=10)
    ax1.invert_yaxis()
    ...
    ax2.set_title('B. NMF Factor-Disease Associations', fontsize=12, fontweight='bold', pad=10)

    # Add text annotations
    for i in range(len(diseases)):
        for j in range(len(factors)):
            text = ax2.text(j, i, f'{association_matrix[i, j]:.2f}',
                            ha="center", va="center", color="black" if association_matrix[i, j] < 0.5 else "white",
    ...
    bars1 = ax3.bar(x - width/2, cf_values, width, label='Achieved', color=COLORS['success'], alpha=0.7, edgecolor='black', linewidth=1.5)
    bars2 = ax3.bar(x + width/2, cf_targets, width, label='Target', color=COLORS['secondary'], alpha=0.5, edgecolor='black', linewidth=1.5)

    ax3.set_ylabel('Value', fontsize=11, fontweight='bold')
    ax3.set_title('C. Counterfactual Explanation Metrics', fontsize=12, fontweight='bold', pad=10)
    ax3.set_xticks(x)
    ...
    bars = ax4.bar(xai_methods, consistency, color=[COLORS['primary'], COLORS['info'],
                                                      COLORS['warning'], COLORS['secondary'], COLORS['success']],
                    alpha=0.7, edgecolor='black', linewidth=1.5)

    ax4.set_ylabel('Consistency (%)', fontsize=11, fontweight='bold')
    ax4.set_title('D. Explanation-Decision Consistency', fontsize=12, fontweight='bold', pad=10)
    ax4.set_ylim(75, 105)
    ...
    # Add target line
    ax4.axhline(y=95, color='red', linestyle='--', linewidth=2, label='Target (95%)', alpha=0.7)
    ax4.legend(fontsize=9, loc='lower right')

    plt.tight_layout()

    # Save figure
    plt.savefig(f'{output_dir}/fig6_xai_methods_comparison.png', dpi=600, bbox_inches='tight')
...
def create_decision_time_analysis(output_dir='outputs/figures'):
    ...
    ax1.hist(decision_times, bins=30, color=COLORS['primary'], alpha=0.7, edgecolor='black', linewidth=1)
    ax1.axvline(np.mean(decision_times), color='red', linestyle='--', linewidth=2, label=f'Mean: {np.mean(decision_times):.2f} ms')
    ax1.axvline(np.median(decision_times), color='orange', linestyle='--', linewidth=2, label=f'Median: {np.median(decision_times):.2f} ms')
    ...
    ax1.set_title('A. Decision Time Distribution (n=500)', fontsize=13, fontweight='bold', pad=10)
    ...
    bp = ax2.boxplot(data_box, labels=labels_box, patch_artist=True, notch=True,
    ...
    colors_box = [RISK_COLORS['R1'], RISK_COLORS['R2'], RISK_COLORS['R3'], RISK_COLORS['R4'], RISK_COLORS['R5']]
    for patch, color in zip(bp['boxes'], colors_box):
        patch.set_facecolor(color)
        patch.set_alpha(0.6)

    ax2.set_ylabel('Decision Time (ms)', fontsize=12, fontweight='bold')
    ax2.set_title('B. Decision Time by Risk Tier', fontsize=13, fontweight='bold', pad=10)
    ax2.grid(axis='y', alpha=0.3, linestyle='--')
    ax2.axhline(y=100, color='green', linestyle=':', linewidth=2, label='Target: <100 ms', alpha=0.7)
    ax2.legend(fontsize=9)

    plt.tight_layout()

    # Save figure
    plt.savefig(f'{output_dir}/fig7_decision_time_analysis.png', dpi=600, bbox_inches='tight')
